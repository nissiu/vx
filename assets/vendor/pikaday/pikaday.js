...
}(this, function (moment)
{
    ...
    renderTitle = function(instance, c, year, month, refYear, randId)
    {
        ...
        if (c === 0) {
            html += '<button class="pika-prev ts-icon-btn' + (prev ? '' : ' is-disabled') + '" type="button">' + opts.i18n.previousMonth + '<svg fill="#000000" width="52" height="52" version="1.1" id="lni_lni-chevron-left" xmlns="http://www.w3.org/2000/svg"xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" xml:space="preserve"><g><path d="M45,62.8c-0.5,0-0.9-0.2-1.3-0.6L18.6,35.4c-1.7-1.9-1.7-4.9,0-6.7L43.7,1.8c0.7-0.7,1.8-0.7,2.5-0.1c0.7,0.7,0.7,1.8,0.1,2.5L21.1,31c-0.5,0.5-0.5,1.4,0,2l25.2,26.8c0.7,0.7,0.6,1.8-0.1,2.5C45.9,62.6,45.4,62.8,45,62.8z"></path></g></svg></button>';
        }
        if (c === (instance._o.numberOfMonths - 1) ) {
            html += '<button class="pika-next ts-icon-btn' + (next ? '' : ' is-disabled') + '" type="button">' + opts.i18n.nextMonth + '<svg fill="#000000" width="52" height="52" version="1.1" id="lni_lni-chevron-right" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" xml:space="preserve"><g><path d="M19,62.8c-0.4,0-0.9-0.2-1.2-0.5c-0.7-0.7-0.7-1.8-0.1-2.5L42.9,33c0.5-0.5,0.5-1.4,0-2L17.7,4.2c-0.7-0.7-0.6-1.8,0.1-2.5c0.7-0.7,1.8-0.6,2.5,0.1l25.2,26.8c1.7,1.9,1.7,4.9,0,6.7L20.3,62.2C19.9,62.6,19.5,62.8,19,62.8z"></path></g></svg></button>';
        }
    ...
    Pikaday = function(options)
    {
        ...
        self._onMouseDown = function(e)
        {
            ...
            if (!hasClass(target, 'is-disabled')) {
                ...
                else if (hasClass(target, 'pika-prev') || target.closest('.pika-prev')) {
                    self.prevMonth();
                }
                else if (hasClass(target, 'pika-next') || target.closest('.pika-next')) {
                    self.nextMonth();
                }
            }
