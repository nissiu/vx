	...
	public function get_elementor_controls(): array {
		return [
			'value' => [
				...
				'options' => [
					'checked' => _x( 'Checked', 'open now filter', 'voxel-backend' ),
					'unchecked' => _x( 'Unchecked', 'open now filter', 'voxel-backend' ),
				],
			],
			'open_in_popup' => [
				'label' => _x( 'Open in Popup', 'open now filter', 'voxel-backend' ),
