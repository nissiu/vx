...
class User_Confirmed_Event extends \Voxel\Events\Base_Event {
	...
	public function get_key(): string {
		return 'membership/user:confirmed';
	}

	public function get_label(): string {
		return 'Membership: User confirmed account';
	}
	...
	public static function notifications(): array {
		return [
			...
			'admin' => [
				...
				'inapp' => [
					'enabled' => true,
					'subject' => 'User confirmed account: @user(:display_name)',
					'details' => function( $event ) {
						return [
							'user_id' => $event->user->get_id(),
						];
				...
				'email' => [
					...
					'subject' => 'User confirmed account: @user(:display_name)',
					'message' => <<<HTML
					User account was confirmed successfully for user <strong>@user(:display_name)</strong>
