	...
	public static function notifications(): array {
		return [
			'user' => [
				...
				'inapp' => [
					'enabled' => false,
					'subject' => 'You have switched to the @user(:plan.label) plan',
			...
			'admin' => [
				...
				'inapp' => [
					'enabled' => true,
					'subject' => '@user(:display_name) switched to the @user(:plan.label) plan: @user(:plan.pricing.amount).currency_format(,true) @user(:plan.pricing.period)',
					'details' => function( $event ) {
						return [
							'user_id' => $event->user->get_id(),
						];
