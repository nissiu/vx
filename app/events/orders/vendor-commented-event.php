...
class Vendor_Commented_Event extends Base_Order_Event {
	...
	public function get_key(): string {
		return $this->product_type
			? sprintf( 'orders/%s/vendor:commented', $this->product_type->get_key() )
			: 'orders/vendor:commented';
	}

	public function get_label(): string {
		return $this->product_type
			? sprintf( '%s: Vendor posted a comment', $this->product_type->get_label() )
			: 'Orders: Vendor posted a comment';
	}

	public static function get_customer_subject() {
		return 'Vendor posted a comment on order #@order(:id).';
	}

	public static function get_customer_message() {
		return <<<HTML
		<p>Order #@order(:id): Vendor posted a comment:</p>
	...
	public static function get_vendor_subject() {
		return 'Order #@order(:id): You posted a comment.';
	}
	...
	public static function get_admin_subject() {
		return 'Order #@order(:id): Vendor posted a comment.';
	}
