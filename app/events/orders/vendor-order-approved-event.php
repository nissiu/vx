...
class Vendor_Order_Approved_Event extends Base_Order_Event {
	...
	public function get_key(): string {
		return $this->product_type
			? sprintf( 'orders/%s/vendor:order_approved', $this->product_type->get_key() )
			: 'orders/vendor:order_approved';
	}

	public function get_label(): string {
		return $this->product_type
			? sprintf( '%s: Order approved by vendor', $this->product_type->get_label() )
			: 'Orders: Order approved by vendor';
	}

	public static function get_customer_subject() {
		return 'Order #@order(:id): Your order has been approved and confirmed.';
	}

	public static function get_customer_message() {
		return <<<HTML
		Order #@order(:id): Your order has been approved and confirmed.
